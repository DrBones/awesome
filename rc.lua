...
-- 		volume = string.format("% 3d", volume)
 	...
 	elseif mode == "down" then
 		...
 		io.popen("amixer -q -c " .. cardid .. " sset LFE toggle"):read("*all")
 		volume("update", widget)
 	end
 end
...
beautiful.init("/home/janosh/.config/awesome/themes/arch/theme.lua")
...
--    vicious.register(batwidget, vicious.widgets.bat, '$2% ', 61, 'BAT0')
    ...
    -- Initialize CPUfreqWidget
    cpufreqwidget = widget({ type = "textbox" })
    vicious.register(cpufreqwidget, vicious.widgets.cpufreq,'$1$5 ',11, 'cpu0')
    -- Create the wibox
